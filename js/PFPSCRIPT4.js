...
}, 
{
    ...
    textContent: "The Third Triad is the microcosm of mind, body, and spirit. Mind Body and Spirit are ONE In the same way that the Prime Fractal is essentially ONE. The strenthing of any one aspect strenthens all three albeit to a lesser degree. Your world view, your emotional and psycological health affect your physical well being and vice versa. It is Important to become aware of your SELF and take the necessary steps to develop it's three aspects to their highest degree. Life itself will force us to develop to acertain degree, however we can achive much more by taking an active role in our development.",
    videoContent: "https://www.youtube.com/embed/dPWaW500cLU"
}, 
{
    buttonLabel: "Mind",
    textContent: "The Mind is the third triad experience as processed by the the brain which qualitatively enhances the spirit which is absorbed into first triad consciousness at death. Wether or not the idividual unit of consciouness maintains it's 'identity' is a matter it's level of qualitative development. The Self is indeed an illusion as the nature of reality is essentially ONE. It is a nescessary illusion for the purposes of development, the ability to see through the illusion indictaes a certain level of development removing the necessity of the illusion.",
    videoContent: "https://www.youtube.com/embed/fajfkO_X0l0"
}, 
{
    buttonLabel: "Body",
    textContent: "The body is a reflection of the mind and is governed by spirit, the body must be nourished with proper nutrition in order to achieve and maintain optimal function, the same is true of both mind and spirit. Click the button titled Practiical PFP to see a method for achieving personal refinement at the third triad level.",
    videoContent: "https://www.youtube.com/embed/J_l_N-EyV7k"
}, 
{
    buttonLabel: "Spirit",
    textContent: "Spirit is the individual unit of consciousness that is at the center of our being, it is an element of the ultimate consciousness of the first triad. This should not be a suprise as it follows logically from our previous statement that ALL is essentially ONE. The experience of life causes qualitative changes in spirit, this qualitative refinement is reabsorbed into first triad level consciousness. Mind-Body-Spirit is the microcosm of Consciosuness-Force-Form, although we cannot perform yoda-esque feats of telekinesis we can excercise an amazing degree of control over our minds and bodies by strenthening the spirit. I doubt we have reached the limits of the capabilities of a fully integrated human being whom has mastered mind,body,and spirit.",
    videoContent: "https://www.youtube.com/embed/HMUKGTkiWik" 
}
];

// Drop down select engine
// Select the pull down from the DOM
var getSelect = getElementById("pfpselect")
// Get select value and monitor for change
var selectValue = getSelect.value
getselect.onchange = function (PFPconsole,selectValue){
	for (i=1,i<13,i+=1){
		// Find text & video content in data table that matches selection 
		if (PFPconsole[i].buttonLabel == selectValue){
			// Change text & video content based on selection 
